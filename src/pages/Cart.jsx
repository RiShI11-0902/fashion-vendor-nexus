...
//     //   return;
//     // }
//     console.log(store.mobileNumber);
...
//                         <h3 className="font-semibold">{item?.name}</h3>
//                         <p className="text-sm text-muted-foreground">{item?.storeName}</p>
//                         <p className="flex flex-row items-center space-x-2 text-lg font-semibold text-primary"><IndianRupee className="w-5" />{item?.price}</p>
//                       </div>
